...
//
//You can perform the following operation with s any number of times (possibly zero): choose two consecutive (i. e. the last character of the first substring should be right before the first character of the second substring} solid contiguous substrings of s, and swap them. It can be shown that the string s stays solid after such an operation.
//
