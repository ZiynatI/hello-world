...
she has to have exactly 𝑛mana before casting the spell, since it is amplified if the caster spends all of their mana on it.
Initially, Alice's character has 1mana. She has got magic potions of two types, which increase her mana points:
...
The only line of each test case contains a single integer 𝑛 (2≤𝑛≤1018).
