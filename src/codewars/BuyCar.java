...
public class BuyCar {
    ...
    //at the end of each considered month but if, by chance from the start, the value of the old car is bigger
    //than the value of the new one or equal there is no saving to be made, no need to wait so he can
    // at the beginning of the month buy the new car:
