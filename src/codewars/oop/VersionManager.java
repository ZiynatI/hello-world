...
public class VersionManager {
    ...
    //More values may be provided after PATCH but they should be ignored. If these 3 parts are not decimal values,
    //an exception with the message "Error occured while parsing version!" should be thrown.
