...
public class Decompose {//Square into Squares. Protect trees!
    ...
    //she has to cut it in pieces which, when assembled, give squares the sides of which form an increasing sequence
    //of numbers. At the beginning it was a lot of fun but little by little we were tired of seeing the pile of torn paper.
