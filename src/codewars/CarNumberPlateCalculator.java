...
public class CarNumberPlateCalculator {
    public static void main(String[] args) {
        System.out.println(findTheNumberPlate(3));
    }
    ...
    //    Customer ID – number between 0 and 17558423 inclusively.
    //    It is assigned to car buyers in the following order: the first customer receives an ID
    //    of 0, the second customer receives an ID of 1, the third - 2, and so on;
