...
public class Minions {
    ...
    //You know how much Commander Lambda hates waste, so if you can prove that these minions are wasting time
    ...
    //Write a function called solution(s) which takes in a string and returns the deciphered string, so you can
    //show the commander proof that these minions are talking about ""Lance & Janice"" instead of doing their jobs.
    //Languages
    //=========
