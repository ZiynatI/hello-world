...
public class CarMileage {
    ...
    //    mileage number input, and returns a 2 if the number is "interesting" (see below), a 1 if an interesting
    //    number occurs within the next two miles, or a 0 if the number is not interesting.
